    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="overflow-x-auto">
          <div className="grid gap-4 md:grid-cols-12 md:items-end min-w-0">
            <div className="md:col-span-4 space-y-2 min-w-0">
              <Label htmlFor="ts-search">Busca</Label>
              <div className="relative w-full">
                <Search className="absolute left-2 top-2.5 h-4 w-4 text-muted-foreground pointer-events-none" />
                <Input
                  id="ts-search"
                  placeholder="Contrato, consultor ou aprovador..."
                  value={searchTerm}
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                      ...
                      <div>
                        ...
                        {(timesheet.file_url || timesheet.id) && (
                          <div className="mt-2">
                            <button
                              ...
                              onClick={async () => {
                                try {
                                  await downloadTimesheetAsExcel(timesheet);
                                } catch (err: any) {
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          Preenchido em{' '}
                          {timesheet.filled_at
                            ? formatDate(timesheet.filled_at)
                            : timesheet.uploaded_at
                              ? formatDate(timesheet.uploaded_at)
